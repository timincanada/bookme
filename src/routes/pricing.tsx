  ...
  return (
    <PageShell>
      <div className="mx-auto w-full max-w-6xl px-5 sm:px-8">
          ...
          {ORDER.map((id) => {
            ...
            return (
              <article
                key={id}
                className={cn(
                  "flex h-full min-w-0 flex-col items-stretch justify-start rounded-2xl bg-card p-7 ring-1 ring-line",
        ...
        <p className="pb-20 pt-8 text-center text-sm text-muted">
